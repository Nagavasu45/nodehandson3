const bollywood=[{
    ...
    deatails:"Pathaan movie review: Shah Rukh Khan and Deepika Padukone-starrer has finally got what’s needed in a spy thriller -- non-stop action, glamorous leads, the guy who can save the world, a high-octane set piece, and an emo line at a time.",
    level:"top",
...
},
{
    ...
    catageory:"bolly",
    heading:"At heart, 'Rocky Aur Rani Kii Prem Kahaani' is an entertaining and sweet love story, with flashy and feisty characters given to us in a well-wrapped shiny package. And yet, it's all about loving your family.",
    ...
    deatails:"Rocky Aur Rani Kii Prem Kahaani story: Opposites attract, and a loud and colourful Punjabi boy, Rocky, and a well-educated Bengali television news anchor, Rani, fall in love. As their families oppose the relationship, they devise a plan—to live in each other’s homes for three months before taking the relationship to the next level.",
    level:"medium",
    indetaildata:"Flamboyant Punjabi Rocky and intellectual Bengali journalist Rani fall in love despite their differences. After facing family opposition, they decide to live with each other's families for three months before getting married."
...
},
{
    ...
    name:"OMG 2",
    catageory:"bolly",
    heading:"Actor Yami Gautam expressed her excitement as 'OMG 2''s box office collection crossed Rupees 120 crore. She said that she was overwhelmed by the love and appreciation received from the audience",
    imgstore:"https://assets-in.bmscdn.com/discovery-catalog/events/et00361712-nldzfskgwv-landscape.jpg",
    deatails:"A diehard bhakt of Lord Shiva, Kanti Sharan Mudgal (Pankaj Tripathi) is forced to question his own thoughts and societal norms on morality, religion and sex after his son gets expelled from school on grounds of obscenity.",
    level:"medium", 
...
},
{
    ...
    deatails:"After Kisi Ka Bhai Kisi Ki Jaan flops, trade expert says Salman Khan ‘needs reality check’",
    level:"medium",
...
},
{
    ...
    deatails:"Post Credits Scene: Luv Ranjan's new film, starring Shraddha Kapoor and Ranbir Kapoor, goes to unbelievable lengths to keep its characters in the dark",
    level:"meduim",
...
},
{
    ...
    deatails:"Ananya Panday is celebrating her first box office century with 'Dream Girl 2'. The actress took to X (formerly called Twitter) to thank her fans.",
    level:"top",
...
module.exports={bollywood,technology,hollywood,food,fitness}
